...
export class HashSet {
    ...
    protected buckets: BucketArray;
    private isRehashing = false;
    ...
    constructor(protected x: number, protected y: number, protected cellWidth: number, protected cellHeight: number, protected capacity: number = 8, protected opacity: number = 1) {
        ...
        this.size = 0;
        this.buckets = new BucketArray(this.x, this.y, this.cellWidth, this.cellHeight, capacity, this.opacity);
    }
    ...
    protected async rehash(context: CanvasRenderingContext2D, newCapacity: number, fadeTime: number = 1) {
        ...
        try {
            ...
            this.buckets = new BucketArray(this.x, this.y + (this.cellHeight * (oldBucketsLen + 1)), this.cellWidth, this.cellHeight, newCapacity, 0);
            this.size = 0;
