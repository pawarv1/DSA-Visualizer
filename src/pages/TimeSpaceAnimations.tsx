...
export function IntroductionAnimation() {
    ...
    // Introduction step callback
    const runIntroductionSteps = (mainContext: CanvasRenderingContext2D, staticContext: CanvasRenderingContext2D, step: number, setIsAnimating: (value: boolean) => void) => {
    ...
    // Pass the callback to StepPlayer
    return <StepPlayer totalSteps={3} runStep={runIntroductionSteps} canvasWidth={canvasWidth} canvasHeight={canvasHeight}></StepPlayer>
}
...
export function BigOAnimation() {
    ...
    // BigO step callback
    const runBigOSteps = (mainContext: CanvasRenderingContext2D, staticContext: CanvasRenderingContext2D, step: number, setIsAnimating: (value: boolean) => void) => {
    ...
    // Pass the callback to StepPlayer
    return <StepPlayer totalSteps={3} runStep={runBigOSteps} canvasWidth={canvasWidth} canvasHeight={canvasHeight}></StepPlayer>
}
...
export function BestWorstAverageAnimation() {
    ...
    // BestWorstAverage step callback
    const runBWASteps = (mainContext: CanvasRenderingContext2D, staticContext: CanvasRenderingContext2D, step: number, setIsAnimating: (value: boolean) => void) => {
    ...
    // Pass the callback to StepPlayer
    return <StepPlayer totalSteps={5} runStep={runBWASteps} canvasWidth={canvasWidth} canvasHeight={canvasHeight}></StepPlayer>
}
...
export function CommonMistakesAnimation() {
    ...
    // CommonMistakes step callback
    const runCommonMistakesSteps = (mainContext: CanvasRenderingContext2D, staticContext: CanvasRenderingContext2D, step: number, setIsAnimating: (value: boolean) => void) => {
    ...
    // Pass the callback to StepPlayer
    return <StepPlayer totalSteps={2} runStep={runCommonMistakesSteps} canvasWidth={canvasWidth} canvasHeight={canvasHeight}></StepPlayer>
}
...
export function BigORules() {
    ...
    // BigORules step callback
    const runBigORulesSteps = (mainContext: CanvasRenderingContext2D, staticContext: CanvasRenderingContext2D, step: number, setIsAnimating: (value: boolean) => void) => {
    ...
    // Pass the callback to StepPlayer
    return <StepPlayer totalSteps={5} runStep={runBigORulesSteps} canvasWidth={canvasWidth} canvasHeight={canvasHeight}></StepPlayer>
}