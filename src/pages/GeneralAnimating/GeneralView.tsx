...
import LineTestCases from './LineTesting';
import ArrowTestCases from './ArrowTesting';
...
function GeneralView() {
    return (
        <div>
            ...
            <CircleTestCases></CircleTestCases><br></br><br></br>
            <h3>Testing Line Class</h3>
            <LineTestCases></LineTestCases><br></br><br></br>
            <h3>Testing Arrow Class</h3>
            <ArrowTestCases></ArrowTestCases>
        </div>
    );
}
