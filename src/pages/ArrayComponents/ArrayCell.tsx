...
export class ArrayCell2D {
    ...
    constructor(x: number, y: number, rowIndex: number, columnIndex: number, cellWidth: number, cellHeight: number, content: any, opacity: number = 1, outlineColor: string = 'black', fillColor: string = 'white', inUse: boolean = true) {
        this.x = x; 
        this.y = y;
