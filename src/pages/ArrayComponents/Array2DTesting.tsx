...
function Array2DTestCases() {
    let canvasWidth = 800;
    let canvasHeight = 600;

    // Array step callback
    const run2DArraySteps = (mainContext: CanvasRenderingContext2D, staticContext: CanvasRenderingContext2D, step: number, setIsAnimating: (value: boolean) => void) => {
        
        // General array initialization test case
        const step1 = () => {
            setIsAnimating(true);
            const testCaseHeader = new Text (70, 40, "General 2D array");
            testCaseHeader.draw(mainContext);
            const array = new Array2D(100, 100, 80, 50, 2, 3, ['a', 'b', 'c', 'd', 'e', 'f']);
        ...
        setIsAnimating(true);
            ...
            const array = new Array2D (100, 100, 80, 50, 2, 2, ['A', 'B', 'C', 'D']);
            const text1 = new Text (100, 300, "Index [-1,0] valid? =", 1, "16px Arial");
            const text2 = new Text (100, 400, "Index [0,0] valid? =", 1, "16px Arial");
            const text3 = new Text (100, 500, "Index [2,2] valid? =", 1, "16px Arial");
            const text4 = new Text (250,300, "", 0);
            const text5 = new Text (250,400, "", 0);
            const text6 = new Text (250,500, "", 0);
            ...
            text4.setContent(array.checkIndexValidity(-1,0).toString());

            // Should not give a console error
            text5.setContent(array.checkIndexValidity(0,0).toString());
            
            // Should give a console error
            text6.setContent(array.checkIndexValidity(2,2).toString());
        ...
        const step3 = () => {
            ...
            const text2 =  new Text (200,300, String(array.getElementAt(1,1)), 0);
        ...
        const step4 = () => {
            ...
            const array = new Array2D (100, 100, 80, 50, 3, 2, ["CSC 325", "CSC 345", "CSC 415", "CSC 435", "CSC 445", "CSC 399"]);
            testCaseHeader.draw(mainContext);
            array.draw(mainContext);
            const text1 = new Text (100, 300, "Array[2,1] = \"CSC 498\"");
            text1.draw(mainContext);
            setTimeout(() => {
                array.setElementAt(mainContext, 2, 1, "CSC 498");
                setIsAnimating(false);
            }, 2000);
        }
        ...
        const step5 = () => {
            ...
            const array1 = new Array2D(100, 100, 80, 50, 2, 2, [10, 20, 30, 40]);
            testCaseHeader.draw(mainContext);
            array1.draw(mainContext);
            array1.setOpacity(mainContext, [1,0], 0.5);
            setIsAnimating(false);
        }
        ...
        const step6 = () => {
            ...
            const array1 = new Array2D(100, 100, 80, 50, 2, 2, [10, 20, 30, 40], 1);
            testCaseHeader.draw(mainContext);
            array1.draw(mainContext);
        ...
        const step7 = () => {
            ...
            const array1 = new Array2D(100, 100, 80, 50, 2, 3, [10, 20, 30, 40, 50, 60]);
            testCaseHeader.draw(mainContext);
            array1.draw(mainContext);
            array1.setOutlineColor(mainContext, 0, 2, "red");
            setIsAnimating(false);
        }
        ...
        const step8 = () => {
            ...
            testCaseHeader.draw(mainContext);
            array1.draw(mainContext);
            array1.setFillColor(mainContext, 0, 2, "yellow");
            setIsAnimating(false);
        }
        ...
        const step10 = () => {
            ...
            const array = new Array2D (100, 100, 80, 50, 3, 2, ['A', 'B', 'C', 'D', 'E', 'F']);
            const text1 = new Text (100, 300, "Array Length =");
            const text2 = new Text (215,300, String(array.getArrayLengthAtRow(1)));
        ...
        const step11 = async () => {
            ...
            const array = new Array2D (50, 100, 80, 50, 2, 3, ['a', 'b', 'c', 'd', 'e', 'f']);
            testCaseHeader.draw(mainContext);
            array.draw(mainContext);
            await array.swapElements(mainContext, 0, 0, 1, 2);
            setIsAnimating(false);
        }
        ...
        const step12 = async () => {
            ...
            const array = new Array2D (50, 100, 30, 30, 3, 3, ["A", "B", "C", "D", "E", "F", "G", "H", "I"]);
            testCaseHeader.draw(mainContext);
            array.draw(mainContext);
